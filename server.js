...
function key(exchangeSegment, securityId){ return `${exchangeSegment}:${String(securityId)}`; }
...
// Runtime registries used by the market-data gateway.
...
const state={
  version:"Bharati-Universal-Dhan-2.0-L20-FIXED",
